            ...
            <div class="product-grid">
                ...
                ?>
                    <div class="product-card">
                        <a class="product-img-wrapper" href="product_detail.php?id=<?= $row['id'] ?>">
                        ...
                        <div class="product-info">
                            ...
                            <div class="product-price"><?= number_format($row['price']); ?> VNĐ / ngày</div>
                            
                            <div class="card-actions">
                                <a href="product_detail.php?id=<?= $row['id'] ?>" class="btn-pill primary">
                ...
                ?>
                    <div style="grid-column: 1 / -1; text-align: center; padding: 50px; color: #777;">
                        <i class="fa-regular fa-gem" style="font-size: 60px; margin-bottom: 20px; color: #ddd;"></i>
                        <p>Hiện chưa có phụ kiện nào được cập nhật.</p>
