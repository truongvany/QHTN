...
$category_id = isset($_GET['category']) && is_numeric($_GET['category']) ? (int)$_GET['category'] : 5;
...
<div class="container" style="padding: 40px 5%; min-height: 60vh;">
    <div class="section-heading">
        <h2 class="section-title"><i class="fa-solid fa-shoe-prints"></i> 
        <?php 
            ...
            <form class="filter-form auto-filter-form" method="get">
                <div class="filter-section">
                    ...
                    <select name="category" class="filter-select" onchange="document.querySelector('.auto-filter-form').submit();">
                        <option value="5" <?= $category_id === 5 ? 'selected' : ''; ?>>Tất cả danh mục</option>
            ...
            <div class="product-grid">
                ...
                ?>
                    <div style="grid-column: 1 / -1; text-align: center; padding: 50px; color: #777;">
                        <i class="fa-solid fa-box-open" style="font-size: 60px; margin-bottom: 20px; color: #ddd;"></i>
                        <p>Hiện chưa có mẫu giày nào được cập nhật.</p>
